...
from softmimicgen_tasks.franka_rope import mdp
from softmimicgen_tasks.franka_rope.env_cfg import EnvCfg
...
class FrankaRopeEnvCfg(EnvCfg):
    def __post_init__(self):
        ...
        self.scene.object = DeformableObjectCfg(
            ...
            init_state=DeformableObjectCfg.InitialStateCfg(pos=(0.5, 0.0, 0.02), rot=(0.707, 0, 0, 0.707)),
            spawn=UsdFileCfg(
