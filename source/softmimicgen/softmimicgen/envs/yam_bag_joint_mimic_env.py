...
class YamBagMimicEnv(ManagerBasedRLMimicEnv):
    """Isaac Lab Mimic environment wrapper class for YAM Bag with Joint Position control."""
    ...
    def __init__(self, cfg, render_mode=None, **kwargs):
        ...
        ik_cfg = DifferentialIKControllerCfg(
            ...
            ik_method="dls",
            ik_params={"lambda_val": 0.2},  # Higher damping for stability (default is 0.01)
        )
    ...
    def get_object_nodal_positions(self, env_ids: Sequence[int] | None = None, num_samples: int = 300):
        """
