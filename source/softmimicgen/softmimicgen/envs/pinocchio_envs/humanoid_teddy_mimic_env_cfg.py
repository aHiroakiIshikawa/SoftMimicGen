...
from softmimicgen_tasks.humanoid.humanoid_teddy_env_cfg import GR1T2TeddyEnvCfg


@configclass
class GR1T2TeddyMimicEnvCfg(GR1T2TeddyEnvCfg, MimicEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.datagen_config.name = "gr1t2_teddy_task"
