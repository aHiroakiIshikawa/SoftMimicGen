...
class DatagenInfo:
    ...
    - **object_poses**: Captures the 6 dimensional poses of relevant rigid objects in the scene.
    - **object_nodal_positions**: Captures the nodal positions of relevant deformable objects in the scene.
    ...
    def __init__(
        ...
        Args:
            ...
            object_poses (dict or None): dictionary mapping object name to object poses
                of shape [..., 4, 4]
            object_nodal_positions (dict or None): dictionary mapping object name to object nodal
                positions of shape [..., N, 3] where N is the number of nodal points
        ...
        self.object_nodal_positions = None
        if object_nodal_positions is not None:
            self.object_nodal_positions = {k: object_nodal_positions[k] for k in object_nodal_positions}
    ...
    def to_dict(self):
        ...
        if self.object_nodal_positions is not None:
            ret["object_nodal_positions"] = deepcopy(self.object_nodal_positions)
