...
PSM_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{SOFTMIMICGEN_ASSETS_DATA_DIR}/Robots/dVRK/PSM/psm_forceps.usd",
...
PSM_HIGH_PD_CFG.actuators["psm"].stiffness = 8000.0
PSM_HIGH_PD_CFG.actuators["psm"].damping = 400.0
